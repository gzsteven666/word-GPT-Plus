...
export const settingPreset = {
  ...
  officialMaxTokens: inputNumSetting(0, 'maxTokens', 'maxTokens'),
  ...
  azureMaxTokens: inputNumSetting(0, 'azureMaxTokens', 'maxTokens'),
  ...
  geminiMaxTokens: inputNumSetting(0, 'geminiMaxTokens', 'maxTokens'),
  ...
  groqMaxTokens: inputNumSetting(0, 'groqMaxTokens', 'maxTokens'),
